    ...
    object FourLetterWordList {
        ...
        private const val fourLetterWords =
            "Area,Army,Baby,Back,Ball,Band,Bank,Base,Bill,Body," +
                    ...
                    "Huge,Just,Keen,Kind,Last,Late,Lazy,Like,Live,Lone," +
                    "Long,Loud,Main,Male,Mass,Mean,Mere,Mild,Nazi,Near," +
                    "Neat,Next,Nice,Okay,Only,Open,Oral,Pale,Past,Pink," +
                    "Poor,Pure,Rare,Real,Rear,Rich,Rude,Safe,Same,Sick," +
                    "Slim,Slow,Soft,Sole,Sore,Sure,Tall,Then,Thin,Tidy," +
                    "Tiny,Tory,Ugly,Vain,Vast,Very,Vice,Warm,Wary,Weak," +
                    "Wide,Wild,Wise,Zero,Ably,Afar,Anew,Away,Back,Dead," +
                    "Deep,Down,Duly,Easy,Else,Even,Ever,Fair,Fast,Flat," +
                    "Full,Good,Half,Hard,Here,High,Home,Idly,Just,Late," +
                    "Like,Live,Long,Loud,Much,Near,Nice,Okay,Once,Only," +
                    "Over,Part,Past,Real,Slow,Solo,Soon,Sure,That,Then," +
        ...
        fun getRandomFourLetterWord(): String {
            ...
            val randomNumber = (allWords.indices).shuffled().first()
            return allWords[randomNumber].uppercase()
        }
    }

    private fun populateGrid() {
        // Directly find the GridLayout from the layout
        val gridLayout = findViewById<GridLayout>(R.id.gridLayout)
        // Set the total number of items and columns based on your game logic
        val total = 12 // For a 4x3 grid
        val columnCount = 4
        ...
        for (i in 0 until total) {
            ...
            // Customize the grid item as necessary
            gridItemView.text = " " // Example: set the text based on your game logic

            // Add the item to the grid layout
